# -*- coding: utf-8 -*-
'''Django settings for Kimani Adserver | Beta project.
...
APPS_DIR = ROOT_DIR.path('Adserver')
...
ADMINS = (
    ('Kimani Adserver | Beta Admin', 'noreply@example.com'),
)
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'Adserver.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "Adserver.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://localhost/Adserver"),
}
